<template>
  <div class="flex flex-col">
    <!-- <div class="hidden md:grid grid-cols-2 gap-x-2 mb-2">
      <img src="/pp.jpg" alt="" class="w-64 rounded-sm grayscale" />
      <img src="/pp-2.jpg" alt="" class="w-64 rounded-sm grayscale" />
    </div>
    ...
    >
      <p class="mb-2 md:text-justify">
        ...
        sparking my passion for creating intuitive and visually engaging digital experiences. This
      ...
      <p class="mb-2 md:text-justify">
        ...
        technologies, I build dynamic, user-centric solutions that enhance efficiency and real-time
